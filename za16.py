...
commands_label1 = tk.Label(text="круг, квадрат, треугольник, звезда, догекагон",
 width=100, font=("Arial", 10))
commands_label1.pack()
commands_label2 = tk.Label(
text="квадрат в круге, треугольник в круге, круг в круге, звезда в круге, догекагон в круге",
 width=100, font=("Arial", 10))
...
input_text.pack()
button_game = tk.Button(text="Нарисовать",
 command=keyboard_input, width=100, font=("Arial", 20))
button_game.pack()
done()