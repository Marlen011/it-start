...
# 19) Заливаем проект с 24 урока на гитхаб
# Миссия 4: Залейте свое приложение на гитхаб

""" 1 с помощью cd переходим в папку которую мы закинем на гитхаб
2 git init чтоб гит начал следить за нашой папкой (следить за всеми изменениями)
3 git remote add origin "url репозитория" пример: https://github.com/Marlen011/Atmosphere-App.git СОЕДИНЯЕТ лоkaльный репозитории с удаленным, доступным по данному url
4 git add . точка выделяет все файлы т.е. подгатавливает выбранные файлы для отправки в гитхаб
5 git commit -m "message" запоминает версию (коммит) всех файлов в репозитории из индекса (индекс то что мы на 4 шаге сделали) и присваивает ей уникальный код (хэш), по которому затем к этой версии можно вернуться
6 git log показывает историю всех коммитов в данной ветке с их хэшами и сообщениями
7 git checkout "хэш нужной версии" можно откатиться на предыдущий код
8 git push <имя репозитория> <ветка> - в имя надо указать куда заливать коммиты т.е. нужный "url" но гит сам автоматически запоминает как называется наш кдаленный репозитории и чтоб не писать url используйте origin. затем указать ветку, в какую ветку загружать
9 git pull <имя репозитория> <ветка> - скачивает из данного удаленного репозитория все коммиты в данной ветке, которых еще нет в локальном репозитории. пример git pull origin master"""


""" Что такое исскуственный интеллект
Искусственный интеллект (ИИ) - это область компьютерных наук, которая занимается созданием программ и систем, способных выполнять задачи, которые требуют интеллектуальной активности человека. Основная цель искусственного интеллекта - создание машин, способных анализировать данные, извлекать знания, принимать решения, обучаться на опыте и решать сложные задачи.
ИИ включает в себя разнообразные подходы и методы, включая:
Машинное обучение: Этот подход позволяет системам обучаться на данных и опыте, чтобы делать предсказания или принимать решения. Основные методы включают нейронные сети, решающие деревья, метод опорных векторов и другие.
Глубокое обучение: Это подмножество машинного обучения, связанное с нейронными сетями с несколькими слоями, известными как глубокие нейронные сети. Глубокое обучение применяется для распознавания образов, обработки естественного языка, анализа текстов, голосового управления и многих других задач.
Обработка естественного языка (Natural Language Processing, NLP): Этот подход занимается взаимодействием между компьютерами и человеческим языком. Системы обработки естественного языка используются для анализа, интерпретации и генерации текста.
Компьютерное зрение: Этот подход касается обработки и анализа изображений и видео. Он используется для распознавания образов, детектирования объектов, анализа медицинских изображений и многих других приложений.
Робототехника: ИИ применяется для разработки автономных роботов и систем управления, позволяя им взаимодействовать с окружающей средой и выполнять различные задачи.
Искусственный интеллект находит применение во многих областях, включая медицину, финансы, автомобильную промышленность, развлечения, науку, образование и другие. Он продолжает развиваться, и его возможности становятся все более широкими и значимыми для нашей повседневной жизни. """
